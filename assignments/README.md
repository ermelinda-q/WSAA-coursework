...
**References**
- Based on topic 5, 'Authentication' - WSAA lecture by A. Beatty.
...
```
git clone https://github.com/ermelinda-q/WSAA-coursework/tree/main/assignments
```
**Please Note:**
- To run assignment04-github.py, you'll need a GitHub Personal Access Token (PAT) with appropriate permissions.
    - Generate a PAT by following this guide: [Managing Personal Access Tokens](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)
    - Create a config.py file in the root directory:
    ```
    config = {
    "githubkey": "your_personal_access_token"
    }
    ```
    - Run the script:
    ```
